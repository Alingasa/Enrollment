            ...
            <fieldset class="border p-4 mb-4">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <input type="text" name="facebook_url" class="form-control @error('facebook_url') is-invalid @enderror" id="facebook_url" value="{{ old('facebook_url') }}" placeholder="Your Facebook URL">
                        @error("facebook_url")
                        <p class="text-danger">{{ $message }}</p>
                        @enderror
                    </div>
